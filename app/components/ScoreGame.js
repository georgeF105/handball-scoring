...
class ScoreGame extends React.Component {
  ...
  render () {
    ...
    const homeTeam = gameInitialized ? game.home_team || {} : this.props.teams[game.home_team_key] || {}
    const awayTeam = gameInitialized ? game.away_team || {} : this.props.teams[game.away_team_key] || {}
